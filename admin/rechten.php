                    ...
                    <div class="col-md-8">
                        <div class="bg-widget2">
                            <div class="bg-widget3">
                                ...
                                $result = mysqli_query($db, "SELECT * FROM permissions");
                                ?>
                                <?php
                                ...
                                ?>
                                    ...
                                    <input class="form-control" type="text" id="myInput" onkeyup="myFunction()" placeholder="Zoek rol..">
                                        ...
                                        <tbody id="example">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-warning" href="./wijzig-rol.php?id=<?php echo $row["id"]; ?>"><span class="fa fa-edit"></span> Wijzig</a></td>
                                                </tr>
                                            <?php
                                                $i++;
                                            }
                    ...
                    <div class="col-md-3">
                        <div class="bg-widget2">
                            <div class="bg-widget3">
                                <p><b>Let op!</b></p>
                                <hr>
                                Het wijzigen van een rol kan ernstige gevolgen hebben!
