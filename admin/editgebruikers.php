                        ...
                        <div class="bg-widget2">
                            <div class="bg-widget3">
                                ...
                                ?>
                                    ...
                                    <input class="form-control" type="text" id="myInput" onkeyup="myFunction()" placeholder="Zoek gebruiker..">
                                        ...
                                        <tbody id="example">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-warning" href="updategebruiker.php?id=<?php echo $row["id"]; ?>"><span class="fa fa-edit"></span> Bewerk</a> / <a class="btn btn-danger" href="verwijder-gebruiker.php?id=<?php echo $row["id"]; ?>"><span class="fa fa-trash"></span> Verwijder</a> / <a class="btn btn-success" href="wijzigwachtwoord.php?id=<?php echo $row["id"]; ?>"><span class="fa fa-lock"></span> Verander Wachtwoord</a></td>
                                                </tr>
                                            <?php
                                                $i++;
                                            }
                    ...
                    <div class="col-md-3">
                        <div class="bg-widget2">
                            <div class="bg-widget3">
                                <p><b>Let op!</b></p>
                                <hr>
                                Het verwijderen van een gebruiker kan niet ongedaan worden!
