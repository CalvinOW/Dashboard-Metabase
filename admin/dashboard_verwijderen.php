                    ...
                    <div class="col-md-8">
                        <div class="bg-widget2">
                            <div class="bg-widget3">
                                ...
                                $result = mysqli_query($db, "SELECT * FROM dashboards");
                                ?>
                                <?php
                                        ...
                                        <tbody id="example">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-danger" href="/admin/verwijder-dashboards.php?id=<?php echo $row["id"]; ?>"><span class="fa fa-trash"></span> Verwijder</a></td>
                                                </tr>
                                            <?php
                                                $i++;
                                            }
